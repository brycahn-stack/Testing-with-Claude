---
tags: [project/voice-journal, architecture]
created: 2026-07-30
---

# Architecture

Part of [[Voice Journal]].
...
|---|---|---|
| `VoiceJournalCore` | iOS + watchOS (framework) | Models, categorizer, store, WC keys — platform-neutral, shared |
| `VoiceJournal` | iOS (app) | Receives recordings, transcribes, categorizes, routes, UI |
| `VoiceJournalWatch` | watchOS (app) | The one-tap mic that captures memos |
